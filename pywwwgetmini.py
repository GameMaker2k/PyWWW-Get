...
def download_file_from_http_string(url, headers=geturls_ua_pywwwget_python_alt, usehttp=__use_http_lib__):
...
def download_file_from_internet_file(url, headers=geturls_ua_pywwwget_python_alt, usehttp=__use_http_lib__):
    urlparts = urlparse(url)
...
def download_file_from_internet_string(url, headers=geturls_ua_pywwwget_python_alt, usehttp=__use_http_lib__):
    urlparts = urlparse(url)
    if(urlparts.scheme == "http" or urlparts.scheme == "https"):
