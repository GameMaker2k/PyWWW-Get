...
class FTPHandler(TransferHandler):
    ...
    def download_file(self, url: str, **kwargs):
        # download_file_from_ftp_file already accepts ftps as well
        return download_file_from_ftp_file(url, **kwargs)

    def download_bytes(self, url: str, **kwargs):
        return download_file_from_ftp_bytes(url, **kwargs)

    def download_to_file(self, url: str, outfile: str, **kwargs):
        return download_file_from_ftp_to_file(url, outfile, **kwargs)

    def upload_file(self, fileobj, url: str, **kwargs):
        return upload_file_to_ftp_file(fileobj, url, **kwargs)

    def upload_bytes(self, data: bytes, url: str, **kwargs):
        return upload_file_to_ftp_bytes(data, url, **kwargs)

    def upload_from_file(self, infile: str, url: str, **kwargs):
        return upload_file_to_ftp_from_file(infile, url, **kwargs)
...
class SFTPHandler(TransferHandler):
    ...
    def download_bytes(self, url: str, **kwargs):
        if self._prefer_pysftp():
            return download_file_from_pysftp_bytes(url, **kwargs)
        return download_file_from_sftp_bytes(url, **kwargs)

    def download_to_file(self, url: str, outfile: str, **kwargs):
        if self._prefer_pysftp():
            return download_file_from_pysftp_to_file(url, outfile, **kwargs)
        return download_file_from_sftp_to_file(url, outfile, **kwargs)

    def upload_file(self, fileobj, url: str, **kwargs):
        if self._prefer_pysftp():
            return upload_file_to_pysftp_file(fileobj, url, **kwargs)
        return upload_file_to_sftp_file(fileobj, url, **kwargs)

    def upload_bytes(self, data: bytes, url: str, **kwargs):
        if self._prefer_pysftp():
            return upload_file_to_pysftp_bytes(data, url, **kwargs)
        return upload_file_to_sftp_bytes(data, url, **kwargs)

    def upload_from_file(self, infile: str, url: str, **kwargs):
        if self._prefer_pysftp():
            return upload_file_to_pysftp_from_file(infile, url, **kwargs)
        return upload_file_to_sftp_from_file(infile, url, **kwargs)
...
class TFTPHandler(TransferHandler):
    ...
    def download_bytes(self, url: str, **kwargs):
        return download_file_from_tftp_bytes(url, **kwargs)

    def download_to_file(self, url: str, outfile: str, **kwargs):
        return download_file_from_tftp_to_file(url, outfile, **kwargs)

    def upload_file(self, fileobj, url: str, **kwargs):
        return upload_file_to_tftp_file(fileobj, url, **kwargs)

    def upload_bytes(self, data: bytes, url: str, **kwargs):
        return upload_file_to_tftp_bytes(data, url, **kwargs)

    def upload_from_file(self, infile: str, url: str, **kwargs):
        return upload_file_to_tftp_from_file(infile, url, **kwargs)
