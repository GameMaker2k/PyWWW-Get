...
if (sys.version[0] == "2"):
    pkgsource = "py2www-get"
if (sys.version[0] == "3"):
    pkgsource = "py3www-get"
pkgupstreamname = "PyWWW-Get"
...
pkggiturl = "https://github.com/GameMaker2k/PyWWW-Get.git"
...
if (sys.version[0] == "2"):
    pkgpackage = "python2-pywww-get"
    pkgoldname = "python2-www-get"
if (sys.version[0] == "3"):
    pkgpackage = "python-pywww-get"
    pkgoldname = "python-www-get"
